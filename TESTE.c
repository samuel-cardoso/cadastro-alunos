...
int main()
{
    ...
    {    
        ...
        case 3:
            ...
            printf("\n Digite a matricula do aluno que voce quer excluir: ");
            int excluirMatricula;
            scanf("%d", &excluirMatricula);
            for (posicao = 1; posicao <= 100; posicao++)
            {
                if (Alunos[posicao].matriculas == excluirMatricula)
                {
                    printf("\n Nome: %s\n Email: %s\n Matricula: %d\n A1: %.1f\n A2: %.1f\n A3: %.1f\n\n", Alunos[posicao].nomes, Alunos[posicao].emails,
                           Alunos[posicao].matriculas, Alunos[posicao].A1, Alunos[posicao].A2, Alunos[posicao].A3);
                    ...
                    if (resposta == 1)
                    {
                        ...
                        for (int exc = posicao; exc < Alunos[posicao].matriculas; exc++)
                        {
                            Alunos[exc].matriculas = Alunos[exc + 1].matriculas;
                        }
                        Alunos[posicao].matriculas--;
